...
// profile Page Routes ===============================================================
    ...
    app.post('/movies', (req, res) => {
      db.collection('movies').save({name: req.body.name, rate: req.body.rate, recommend: req.body.recommend, genre: req.body.genre, movietNotes: req.body.movieNotes}, (err, result) => {
        if (err) return console.log(err)
        console.log(result)
